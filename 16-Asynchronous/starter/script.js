...
// Promise.race([getJSON(`https:restcountries.com/v3.1/name/tanzania`), timeout(5)])
...
// // Outputs array of fulfilled/rejected promises + messages
...
//     .then(res => console.log(res))
//     .catch(err => console.error(err));
// // Errors out because of one reject
...
//     .then(res => console.log(res))
//     .catch(err => console.error(err));
// // Outputs 'SUCCESS' if at least one fulfilled promise
